...
comments and ignored.\n", 80, 0);
        ...
        printf(TYPE_SIMULATION);
        printf("\n  ");
        printf(TYPE_SAMPLE);
        printf("\n  ");
        printf(TYPE_PARTICLE);
        printf("\n  ");
        printf(TYPE_PARTICLESET);
        printf("\n  ");
        printf(TYPE_GEOMETRY);
        printf("\n  ");
        printf(TYPE_ELECTRONBEAM);
        printf("\n  ");
        printf(TYPE_OPTICS);
        printf("\n  ");
        printf(TYPE_DETECTOR);
        printf("\n  ");
        printf(TYPE_VOLUME);
        printf("\n\n");
...
int main(int argc, char **argv) {
    ...
    write_log_comment("Simulation time: %.f seconds\n", seconds);
